...
| 06 | AC6 실사용 확인 기록 — **트랙 완료 조건** (F6·D11) — **릴리스·push·spark2 갱신 뒤, SDD 디스패치 대상 아님** | [ ] | [task-06](2026-09-24-orca-successor-session/task-06-ac6-field-run.md) | 05 + push + spark2 설치 갱신 | |
...
**설치 버전**: <task-06이 spark2 `/dev-workflow:doctor` 출력의 설치본 버전으로 채운다 — 예 `1.0.0`>
